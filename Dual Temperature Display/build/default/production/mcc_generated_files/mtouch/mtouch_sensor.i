...
static mtouch_sensor_t mtouch_sensor[1u] ={
    {Sensor_ANA5,MTOUCH_CVD_ScanA_0,MTOUCH_CVD_ScanB_0, 32u,0,0,0,0},
};
...
# 195 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_SampleAll(void)
{
    enum mtouch_sensor_names sensor;
    for (sensor = 0; sensor < 1u; sensor++)
...
# 223 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_isAnySensorActive(void)
{
    enum mtouch_sensor_names sensor;
...
# 389 "mcc_generated_files/mtouch/mtouch_sensor.c"
static void Sensor_Acq_ExecuteScan(void)
{
...
# 441 "mcc_generated_files/mtouch/mtouch_sensor.c"
static enum mtouch_sensor_error Sensor_Scanfrequency_Evaluation(mtouch_sensor_t* sensor)
{
    uint8_t i;
...
# 553 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Disable(enum mtouch_sensor_names sensor)
{
    if(sensor < 1u)
...
# 588 "mcc_generated_files/mtouch/mtouch_sensor.c"
static __attribute__((inline)) void Sensor_setActive(mtouch_sensor_t* sensor)
{
    sensor->active = 1;
}
...
# 625 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Sampled_ResetAll(void)
{
